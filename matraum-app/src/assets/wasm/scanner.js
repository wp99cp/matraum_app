...
var wasmMemory;
var wasmTable = new WebAssembly.Table({"initial": 14, "maximum": 14, "element": "anyfunc"});
var ABORT = false;
var EXITSTATUS = 0;
...
var DYNAMIC_BASE = 5378928, DYNAMICTOP_PTR = 136032;
...
var wasmBinaryFile = "assets/wasm/scanner.wasm";
...
var _scan_image = Module["_scan_image"] = function () {
  return (_scan_image = Module["_scan_image"] = Module["asm"]["j"]).apply(null, arguments)
};
var _create_buffer = Module["_create_buffer"] = function () {
  return (_create_buffer = Module["_create_buffer"] = Module["asm"]["k"]).apply(null, arguments)
};
var _destroy_buffer = Module["_destroy_buffer"] = function () {
  return (_destroy_buffer = Module["_destroy_buffer"] = Module["asm"]["l"]).apply(null, arguments)
};
...
function run(args) {
  ...
  function awaitRuntimeInitialiezed() {
